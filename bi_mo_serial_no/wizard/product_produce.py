...
class MrpProductProduce(models.TransientModel):
    ...
    def continue_production(self):
        ...
        if production_id:
            production = self.env['mrp.production'].browse(production_id)
            production.write({'producing_quantity':(production.producing_quantity+self.qty_producing),'is_producing_qty':True})
            production.write({'qty_producing':production.producing_quantity})
    ...
    def do_produce(self):
        ...
        if production_id:
            ...
            if production.qty_producing == production.product_qty:
                production.write({'state':'to_close'})
